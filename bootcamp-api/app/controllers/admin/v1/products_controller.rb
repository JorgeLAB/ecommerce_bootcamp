module Admin::V1
  class ProductsController < ApiController
    ...
    def product_params
      ...
      permitted_params = params.require(:product).permit(:id, :name, :description, :image, :price, :productable, :status, :featured, category_ids: [])
    ...
    def productable_params
      productable_type = params.dig(:product, :productable) || @product&.productable_type&.underscore
